...
await page.addInitScript(() => { window.__PIN_PHASE__ = 0.798 }) // composition gates must not breathe with the real calendar (the BR roof slope went flat at phase 0.805)
    page.on('console', (msg) => {
      const type = msg.type()
