...
// budgets per PRESTIGE_PASS Q.4 (supersedes MASTER_PROMPT Part 11)
check('draw calls ≤ 150 (heaviest view)', maxCalls <= 150, `${maxCalls}`)
check('tris ≤ 250k (heaviest view)', maxTris <= 250000, `${maxTris}`)
check('bundle ≤ 1.4MB gz', gzKB <= 1433, `${gzKB}KB`)
