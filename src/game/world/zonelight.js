...
export const ZONES = {
  park: {
    ...
    x: 0, z: 0, r: 42,
    skyStops: ['#0a111d', '#0e1b25', '#122830', '#193039', '#203841'],
    fog: '#203841', fogNear: 8, fogFar: 45,
  ...
  village: {
    ...
    x: 110, z: 0, r: 48,
    skyStops: ['#070913', '#0f0d26', '#151132', '#1b143d', '#221849'],
    fog: '#221849', fogNear: 10, fogFar: 52,
  ...
  rooftops: {
    ...
    skyStops: ['#0a0a1d', '#0e0d26', '#111132', '#14153d', '#181949'],
    fog: '#181949', fogNear: 14, fogFar: 70,
  ...
  ruins: {
    ...
    x: -110, z: 0, r: 46,
    skyStops: ['#130d19', '#1c171c', '#241a28', '#2d1e33', '#35253c'],
    fog: '#35253c', fogNear: 9, fogFar: 48,
  ...
  gloomspire: {
    ...
    x: -110, z: 110, r: 52,
    skyStops: ['#0d0a18', '#13111c', '#1f132f', '#29143d', '#301b46'],
    fog: '#301b46', fogNear: 10, fogFar: 55,
  ...
  mosswood: {
    ...
    skyStops: ['#0e1817', '#132020', '#162b2c', '#1d352f', '#233e33'],
    fog: '#233e33', fogNear: 6, fogFar: 30,
  ...
  isle: {
    ...
    x: 0, z: -150, r: 55,
    skyStops: ['#0a0f1c', '#0f1424', '#1a2729', '#1a3038', '#1f3842'],
    fog: '#1f3842', fogNear: 12, fogFar: 65,
  ...
  foglandPV: {
    ...
    skyStops: ['#0a0f1c', '#0e1525', '#151d2d', '#1d2635', '#24303d'],
    fog: '#24303d', fogNear: 2, fogFar: 13,
    ambient: '#8fa0a4', skyUp: '#333f52',
    accent: '#e8c26a', audioZone: null, fogland: true,
  },
  foglandPR: {
    name: 'The Foglands', x: -58, z: 0, r: 22,
    skyStops: ['#0f0d19', '#18141f', '#211a28', '#2a2131', '#332938'],
    fog: '#332938', fogNear: 2, fogFar: 13,
    ambient: '#9a92a4', skyUp: '#443a54',
    accent: '#e8c26a', audioZone: null, fogland: true,
  },
  foglandPI: {
    name: 'The Foglands', x: 0, z: -78, r: 24,
    skyStops: ['#0b101b', '#0e1625', '#141f2e', '#1a2a37', '#203441'],
    fog: '#203441', fogNear: 2, fogFar: 14,
    ambient: '#93a8ae', skyUp: '#31485a',
    accent: '#e8c26a', audioZone: null, fogland: true,
  },
  foglandRG: {
    name: 'The Foglands', x: -110, z: 57, r: 24,
    skyStops: ['#110c1a', '#191320', '#231929', '#2d2032', '#352739'],
    fog: '#352739', fogNear: 2, fogFar: 13,
